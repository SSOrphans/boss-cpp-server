...
class grpcConan(ConanFile):
    ...
    def source(self):
        ...
        if tools.Version(self.version) >= "1.39.0":
            ...
            tools.replace_in_file(os.path.join(self._source_subfolder, "CMakeLists.txt"),
                    ...
                    "if(gRPC_INSTALL)")
        tools.get("https://github.com/google/googletest/archive/refs/tags/release-1.10.0.tar.gz",
                destination="source_subfolder/third_party/googletest", strip_root=True)
        tools.get("https://github.com/google/benchmark/archive/refs/tags/v1.5.2.tar.gz",
                destination="source_subfolder/third_party/benchmark", strip_root=True)
    ...
    def _configure_cmake(self):
        ...
        self._cmake.definitions["gRPC_BUILD_TESTS"] = True
